                ...
                <li>Technologies utilisées</li>
                    <div class="col-md-6">
                        ...
                        <div class="description">
                            <p> Nous avons containerisé les différents composants de l'application (Base de données, Serveur Web, phpMyAdmin) pour homogénéiser notre environement et être capable de le deployer rapidement</p>
                            <p> Nous utilisons également Docker Compose pour orchestrer ces containers et être capable de les deployer en une seul commande.
                        </div>
                    </div>
                    <div class="col-md-6">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/PHP-logo.svg/711px-PHP-logo.svg.png">
                        <div class="title text-left">
                            <p>PHP</p>
                        </div>
                        <div class="description">
                            <p> Notre back-end utilise le langage php</p>
                        </div>
                    </div>
                    <div class="col-md-6">
