...
$GLOBALS['key_service'] = new KeywordService(new Connect());

//$app->get('/', HomeController::class.':index');
$app->get('/', PathologyController::class.':index');
...
$app->post('/keyword-filter', PathologyController::class.':keywordFilter');
